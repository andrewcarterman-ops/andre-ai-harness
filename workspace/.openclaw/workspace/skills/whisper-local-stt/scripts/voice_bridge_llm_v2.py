#!/usr/bin/env python3
"""
Voice Bridge - Direct LLM Integration v2
...
def send_request(text):
    ...
    print("\n[⚠️ Timeout - keine Antwort erhalten]")
    try:
        request_file.unlink()
    except:
        pass
...
def main():
    ...
    if not TRANSCRIBE_SCRIPT.exists():
        print(f"\n[❌ Transcribe nicht gefunden: {TRANSCRIBE_SCRIPT}]")
        return
    
    print("\n[✅ Bereit!]")
    print("\n👉 WICHTIG: Starte in einem ANDEREN Terminal:")
    print("   python voice_bridge_autoresponder.py")
    print("\nDann starte hier die Voice Bridge und sprich los!")
    print("="*60)
